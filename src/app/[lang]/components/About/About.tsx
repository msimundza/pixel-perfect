  ...
  return (
    <div className="pb-12 pt-20 mt-10 lg:mr-1 lg:ml-1 xl:mr-4 xl:ml-4">
      <div className="flex flex-col md:flex-row md:flex-wrap">
        <h3 className="md:order-1 element-scale-up text-center uppercase text-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl flex items-center justify-center w-full md:w-1/2 mb-2">
          {title1}
        </h3>
        ...
        <h3 className="md:order-4 element-scale-up text-center uppercase text-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl flex items-center justify-center w-full md:w-1/2 mb-2">
          {title2}
        </h3>
        ...
        <h3 className="md:order-5 element-scale-up text-center uppercase text-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl flex items-center justify-center w-full md:w-1/2 mb-2">
          {title3}
        </h3>
        ...
        <h3 className="md:order-8 element-scale-up text-center uppercase text-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl flex items-center justify-center w-full md:w-1/2 mb-2">
          {title4}
        </h3>
